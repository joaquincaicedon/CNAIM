#' @importFrom magrittr %>%
#' @title Probabilidad futura de falla para transformadores de 13.2kV
#' @description Esta función calcula la probabilidad futura
#' anual de falla para transformadores de 13.2kV.
#' La función es una curva cúbica basada en
#' los primeros tres términos de la serie de Taylor para una
...
#' junto con el puntaje de salud futuro
